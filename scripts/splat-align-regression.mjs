...
assert.match(source, /maxDistance: 1\.3,/, "HMC orbit max distance should be 1.3 units.");
...
assert.doesNotMatch(source, /maxRadiusFromOrigin: 1\.3\b/, "The 1.3-unit zoom limit should not be implemented as a world-origin radius clamp.");
